[![NPM](https://nodei.co/npm/@trrxitte/xtenetwork-ha.png?downloads=true&stars=true)](https://nodei.co/npm/@trrxitte/xtenetwork-ha/)
...
var daemon = new XTEnetwork({
  ...
  rpcBindPort: 14485, // What Port to bind the RPC server to
